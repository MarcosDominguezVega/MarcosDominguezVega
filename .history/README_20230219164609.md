...
<p style="font-weight: 700; color: black; background: linear-gradient(90deg, violet, white, lightgreen); hover:background: linear-gradient(90deg, lightblue, white, darkblue)">SOY UN CHICO DE CIUDAD QUE APRENDE DESARROLLO WEB DE UNA FORMA ALTERNA QUE QUIERO DECIR, QUE SEGÚN DESCUBRO ALGO ME ESPECIALIZÓ EN ELLO TANTO COMO SE NECESARIO.</p>
