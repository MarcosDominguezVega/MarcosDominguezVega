...
<p style="font-weight: 700; color: black; border: 2px inset whitesmoke; padding: 1%; border-radius: 20px; background: linear-gradient(90deg, darkviolet, gray, lightgreen);)">SOY UN CHICO DE CIUDAD QUE APRENDE DESARROLLO WEB DE UNA FORMA ALTERNA QUE QUIERO DECIR, QUE SEGÚN DESCUBRO ALGO ME ESPECIALIZÓ EN ELLO TANTO COMO SE NECESARIO.</p>
